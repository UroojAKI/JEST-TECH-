...
export const autoConfig: VehicleCategoryConfig = {
  ...
  fields: [
    {
      ...
      label: 'Licensed Passenger Capacity',
      type: 'number',
      required: true,
      min: 3,
      max: 6,
    ...
    {
      name: 'fareMeterFitted',
      label: 'Digital Fare Meter Fitted',
      type: 'boolean',
      required: false,
    },
  ],
  allowedAddons: [
    {
      code: 'PA_PASSENGERS',
      name: 'PA Cover for Passengers',
      description: '?1 Lakh to ?2 Lakh accident cover per passenger',
      defaultSelected: true,
    },
    {
      code: 'LEGAL_LIABILITY_PAID_DRIVER',
      name: 'Legal Liability to Driver',
      description: 'Covers auto driver liability',
      defaultSelected: true,
    },
  ],
  requiredDocuments: {
    ...
    existingComprehensive: [
      'Auto Rickshaw RC Copy',
      'Auto Permit & Fitness Copy',
    ],
    breakInInspection: [
      'Auto RC Copy',
      'Fitness Certificate',
