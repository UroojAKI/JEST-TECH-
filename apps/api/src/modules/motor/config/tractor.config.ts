...
export const tractorConfig: VehicleCategoryConfig = {
  ...
  fields: [
    ...
    {
      name: 'hasTrailer',
      label: 'Attached Trolley / Trailer',
      type: 'boolean',
      required: false,
    },
    {
  ...
  allowedAddons: [
    {
      code: 'TRAILER_COVER',
      name: 'Trailer / Trolley Comprehensive Cover',
      description: 'Covers attached agricultural or commercial trailer',
    },
    {
      code: 'LEGAL_LIABILITY_PAID_DRIVER',
      name: 'Legal Liability to Driver',
      description: 'Driver liability cover',
      defaultSelected: true,
    },
    {
      code: 'PA_UNNAMED_PASSENGERS',
      name: 'PA Cover for Farm Helpers',
      description: 'Accident cover for agricultural helpers',
    },
  ],
  requiredDocuments: {
    newVehicle: [
      'Tractor Dealership Invoice',
      'Form 21',
      'Farmer 7/12 Land Record / Kisan Card',
    ],
