...
export const taxiConfig: VehicleCategoryConfig = {
  ...
  fields: [
    {
      ...
      label: 'Seating Capacity (inc. Driver)',
      type: 'number',
      required: true,
      min: 4,
      max: 7,
  ...
  allowedAddons: [
    {
      code: 'PA_PASSENGERS',
      name: 'Passenger Personal Accident Cover',
      description: 'Legal liability & PA for paid passengers',
      defaultSelected: true,
    },
    {
      code: 'LEGAL_LIABILITY_PAID_DRIVER',
      name: 'Legal Liability to Chauffeur / Driver',
      description: 'Protects commercial fleet operator',
      defaultSelected: true,
    },
    {
      code: 'ZERO_DEP',
      name: 'Zero Depreciation for Taxi',
      description: 'Nil depreciation on replacement parts',
  ...
  requiredDocuments: {
    ...
    existingComprehensive: [
      'RC with Commercial Yellow Plate Endorsement',
      'Fitness Certificate',
      'Permit Copy',
    ],
    breakInInspection: [
