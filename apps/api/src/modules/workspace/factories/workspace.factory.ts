...
export class WorkspaceFactory {
  createDefaultWorkspace(jobRoleCode?: string, roleCode?: string, jobRoleName?: string) {
    ...
    if (roleUpper.includes('SALES') || roleUpper.includes('POSP') || roleUpper.includes('AGENT')) {
      return this.getSalesExecWorkspace(jobRoleName);
    }
    ...
    if (roleUpper.includes('POLICY_ISSUANCE') || roleUpper.includes('OPERATIONS') || roleUpper.includes('UNDERWRITER') || roleUpper.includes('BACK_OFFICE') || roleUpper.includes('BACK OFFICE')) {
      return this.getOperationsWorkspace(jobRoleName);
    }
    ...
    if (roleUpper.includes('MD_CEO') || roleUpper.includes('CEO') || roleUpper.includes('DIRECTOR')) {
      return this.getExecutiveWorkspace(jobRoleName);
    }
  ...
  private getAdminWorkspace(name?: string) {
    return {
      ...
      permissions: ['admin:read', 'admin:manage', 'user:manage', 'policy:read', 'finance:read'],
    };
  }
  ...
  private getSalesManagerWorkspace(name?: string) {
    return {
      ...
      subtitle: 'Team premium, conversion rate, SLA escalations, and quotation approvals',
      navigation: [
        { id: 'sm-dash', title: 'Team Dashboard', href: '/workspace/sales-manager', icon: 'LayoutDashboard' },
        { id: 'team-performance', title: 'Team Performance', href: '/sales/team', icon: 'Users' },
        { id: 'approvals', title: 'Quotation Approvals', href: '/sales/approvals', icon: 'CheckSquare' },
        { id: 'escalations', title: 'Escalations', href: '/sales/escalations', icon: 'ShieldAlert' },
      ],
      widgets: [
        { id: 'team-metrics', type: 'KPI', title: 'Team Production Metrics', colSpan: 12 },
        { id: 'pending-approvals', type: 'TABLE', title: 'Pending Quotation Approvals', colSpan: 8 },
        { id: 'sla-alerts', type: 'LIST', title: 'SLA Escalations', colSpan: 4 },
      ],
      quickActions: [
        { id: 'review-quote', title: 'Review Quotations', href: '/sales/approvals', icon: 'CheckSquare' },
      ],
  ...
  private getSalesExecWorkspace(name?: string) {
    return {
      ...
      widgets: [
        ...
        { id: 'hot-leads', type: 'TABLE', title: 'Hot Leads & Follow-ups', colSpan: 8 },
  ...
  private getRenewalWorkspace(name?: string) {
    return {
      ...
      navigation: [
        ...
        { id: 'expiring-policies', title: 'Expiring Policies', href: '/policies', icon: 'Clock' },
      ...
      widgets: [
        ...
        { id: 'retention-metrics', type: 'METRIC', title: 'Retention Ratio', colSpan: 4 },
      ],
      quickActions: [
  ...
  private getCustomerServiceWorkspace(name?: string) {
    return {
      ...
      widgets: [
        { id: 'csat-metric', type: 'KPI', title: 'Customer Satisfaction Score', colSpan: 12 },
        { id: 'open-tickets', type: 'TABLE', title: 'Active Customer Inquiries', colSpan: 8 },
        { id: 'recent-claims', type: 'LIST', title: 'Recent Claims', colSpan: 4 },
      ],
      quickActions: [
        { id: 'new-contact', title: 'Add Customer Contact', href: '/crm/contacts', icon: 'UserPlus' },
      ],
      permissions: ['contact:read', 'claim:read', 'claim:create', 'policy:read'],
    };
  }
  ...
  private getAgentRMWorkspace(name?: string) {
    return {
      ...
      subtitle: 'POSP onboarding, licensing compliance, production leaderboards',
      navigation: [
        { id: 'agent-dash', title: 'ARM Workspace', href: '/workspace/agent-relationship', icon: 'Users' },
        { id: 'agent-roster', title: 'Active Agents', href: '/agent/roster', icon: 'ShieldCheck' },
        { id: 'training', title: 'Training Logs', href: '/agent/training', icon: 'BookOpen' },
      ],
      widgets: [
        { id: 'agent-kpis', type: 'KPI', title: 'Active Agents & GWP', colSpan: 12 },
        { id: 'agent-leaderboard', type: 'TABLE', title: 'Top Performing POSPs', colSpan: 8 },
        { id: 'agent-retention', type: 'METRIC', title: 'Agent Retention', colSpan: 4 },
      ],
      quickActions: [
        { id: 'onboard-agent', title: 'Onboard New POSP', href: '/agent/roster', icon: 'UserPlus' },
      ],
  ...
  private getOperationsWorkspace(name?: string) {
    return {
      ...
      widgets: [
        ...
        { id: 'underwriting-queue', type: 'TABLE', title: 'Pending Proposals', colSpan: 8 },
        { id: 'pending-verifications', type: 'LIST', title: 'Verifications Required', colSpan: 4 },
      ],
      quickActions: [
  ...
  private getFinanceWorkspace(name?: string) {
    return {
      ...
      navigation: [
        ...
        { id: 'commissions', title: 'Commissions', href: '/finance/commissions', icon: 'Percent' },
      ],
      widgets: [
        { id: 'fin-kpis', type: 'KPI', title: 'Revenue & Ledgers', colSpan: 12 },
        { id: 'recent-vouchers', type: 'TABLE', title: 'Journal Postings', colSpan: 8 },
        { id: 'pending-payouts', type: 'LIST', title: 'Pending Payouts', colSpan: 4 },
      ],
      quickActions: [
        { id: 'post-journal', title: 'Post Journal', href: '/finance/ledger', icon: 'PlusCircle' },
      ],
  ...
  private getMarketingWorkspace(name?: string) {
    return {
      ...
      navigation: [
        { id: 'marketing-dash', title: 'Marketing Hub', href: '/workspace/marketing', icon: 'Megaphone' },
        { id: 'campaigns', title: 'Campaign Calendar', href: '/marketing/campaigns', icon: 'Calendar' },
        { id: 'leads', title: 'Generated Leads', href: '/crm/leads', icon: 'Users' },
      ],
      widgets: [
        { id: 'campaign-roi', type: 'KPI', title: 'Lead Generation ROI', colSpan: 12 },
        { id: 'source-attribution', type: 'CHART', title: 'Leads by Source', colSpan: 8 },
        { id: 'active-campaigns', type: 'LIST', title: 'Active Campaigns', colSpan: 4 },
      ],
      quickActions: [
        { id: 'new-campaign', title: 'Launch Campaign', href: '/marketing/campaigns', icon: 'PlusCircle' },
      ],
  ...
  private getExecutiveWorkspace(name?: string) {
    return {
      ...
      navigation: [
        ...
        { id: 'revenue', title: 'GWP Analytics', href: '/dashboard/reports/executive', icon: 'TrendingUp' },
        { id: 'bi-reports', title: 'BI Reports', href: '/dashboard/reports', icon: 'BarChart3' },
      ],
      widgets: [
        { id: 'gwp-kpi', type: 'KPI', title: 'Gross Written Premium (GWP)', colSpan: 12 },
        { id: 'zonal-chart', type: 'CHART', title: 'Branch Contribution', colSpan: 8 },
        { id: 'top-metrics', type: 'METRIC', title: 'Top Performers', colSpan: 4 },
      ],
      quickActions: [
        { id: 'exec-report', title: 'Generate PDF Report', href: '/dashboard/reports/executive', icon: 'FileDown' },
      ],
      permissions: ['report:read', 'report:export', 'policy:read', 'finance:read', 'lead:read'],
    };
  }
  ...
  private getGenericEmployeeWorkspace(name?: string) {
    return {
      ...
      navigation: [
        { id: 'emp-dash', title: 'My Workspace', href: '/workspace/employee', icon: 'User' },
      ],
      widgets: [
  ...
  private getSafeSystemDefaultWorkspace() {
    return {
      ...
      subtitle: 'A minimal workspace when your role configuration is unavailable',
      navigation: [
        { id: 'safe-dash', title: 'Dashboard', href: '/workspace', icon: 'LayoutDashboard' },
        { id: 'safe-profile', title: 'My Profile', href: '/profile', icon: 'User' },
        { id: 'safe-help', title: 'Help & Support', href: '/help', icon: 'HelpCircle' },
      ],
      widgets: [
        { id: 'welcome-widget', type: 'ACTIONS', title: 'Welcome to JEST Policy CRM', colSpan: 12 },
      ],
      quickActions: [],
      permissions: [],
    };
